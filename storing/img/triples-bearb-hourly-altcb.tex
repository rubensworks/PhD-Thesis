...
\pagestyle{empty}
\begin{tikzpicture}
    \begin{axis}[width=7cm,height=3cm,ylabel={Triples},xlabel={Version}]
        \addplot[color=one,thick,mark=*,mark options={solid,fill=one},mark size=0.3] table [x=v, y=count, col sep=comma] {data/bearb-hourly/altcbstats.csv};
    \end{axis}
