...
\begin{tikzpicture}[
    ...
    \draw[->,thick](delta2) to [out=135,in=45] (delta1);
    \draw[->,thick](delta3) to [out=135,in=45] (delta2);
    \draw[->,thick](delta4) to [out=135,in=45] (delta3);
    \draw[->,thick](delta5) to [out=135,in=45] (delta4);
